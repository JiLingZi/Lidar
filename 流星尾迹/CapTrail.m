...
DateList = {'20240826';'20240828';'20240830';...
            '20240901';'20240902';'20240906';'20240910';};
...
for jt = 1:ceil(num_files/24)
    ...
    % 指定保存路径和文件名
    figPath = "F:\TrailIMG\Cap\"+ReadDate+"\";
...
% % 
% % %% 平均密度廓线
% % MeanPorfile = sum(NumberZ(:,220:end), 2);
% % plot(Altitude, MeanPorfile,'-','linewidth',2)
% % xlim([75 125])
...
%% 尾迹变化图
% TimeTrail = TimeX(:,1764:1769)';
% DenTrail = [850 961 442 294 187 100];
% AltTrail = [97.75 97.91 98.06 98.21 98.34 98.34];
% Profx = 1764;
% 
% yyaxis left
...
%     hold on;
% end
% title('Ca Ion 20231106T21:09:29')
% xlim([203 212]);
% ylim([75 115]);
% xInterval = 1;  % x轴刻度间隔
% 
...
% ttstr = "Ca^{+} " + ReadDate;
% title(ttstr)
% TX1 = double(14+(45/60))+8;
% TX2 = double(14+(51/60))+8;
% % xticks = Time;
% xlim([TX1 TX2]);
% ylim([80 100]);
