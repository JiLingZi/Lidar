%{
项目名称：锂原子有效后向散射截面计算程序
作者名称：王可鑫
作者单位：江苏科技大学理学院
作者邮箱：wangkexin1998@qq.com
导师名称：王泽龙
版本编号：MATLAB-3
创建时间：2023/10/07/19:31:51
修改时间：2023/10/07/19:45:07
%}
...
%激光常数
lambda_L = 670.776e-9;      %激光波长(m)
nu_L = c / lambda_L;        %激光中心频率(Hz)

%专用常数
T = 200;                    %温度为200K条件下
M = 6.941*1.6606e-27;       %原子绝对质量(kg)
% fD1 = 0.7478;               %振子强度
fD1 = 0.5;
IsoAbdn = 1;                %同位素丰度
sigma_FWHM = 1.7124e9;      %激光测量线宽；半高全宽
