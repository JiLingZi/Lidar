...
%激光常数
lambda_L = 341.476e-9;%激光波长(m)
nu_L = c / lambda_L;%激光中心频率(Hz)

%专用常数
T = 200;%温度为200K条件下
M = 9.761e-26;%原子绝对质量(kg)
fD1 = 0.024;%振子强度
IsoAbdn = 1;%Fe的同位素丰度
sigma_FWHM = 0.5e9;%激光测量线宽；半高全宽
...
sprintf('Ni原子341线的有效后向散射截面为\n%e m^2/sr',sigma_K)
%{
plot(sigma_FWHM,sigma_K,'-','color',[0.85 0.44 0.84], 'Linewidth', 2)
set(gca,'FontSize',18);
